...
abstract class RouterStrategy {
  ...
  /// ```
  Future<void> pushRemoveUntil(BuildContext context, String routeName,
      {Object? args, Map<String, dynamic> kwargs});
  ...
  /// ```
  Future<void> pushReplacement(BuildContext context, String routeName,
      {Object? args, Map<String, dynamic> kwargs});
}
...
class AppRouter {
  ...
  Future<void> pushRemoveUntil(BuildContext context, String routeName,
      {Object? args, Map<String, dynamic> kwargs = const {}}) async {
    await _routeStrategy.pushRemoveUntil(context, routeName,
  ...
  Future<void> pushReplacement(BuildContext context, String routeName,
      {Object? args, Map<String, dynamic> kwargs = const {}}) async {
    await _routeStrategy.pushReplacement(context, routeName,
        args: args, kwargs: kwargs);
  }
}
